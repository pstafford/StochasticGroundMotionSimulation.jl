...
function peak_factor_dk80(m::T, r::T, fas::Union{FASParams,FASParamsGeo,FASParamsQr,FASParamsGeoQr}, sdof::Oscillator{T}; fc_fun::Symbol=:Brune, amp_model::Symbol=:AlAtik2021_cy14, intervals::Int=101) where T<:Real
	# compute first three spectral moments
	mi = spectral_moments([0, 1, 2], m, r, fas, sdof, fc_fun=fc_fun, amp_model=amp_model)
	m0 = mi[1]
	m1 = mi[2]
	m2 = mi[3]
...
function peak_factor_dk80_gk(m::T, r::T, fas::Union{FASParams,FASParamsGeo,FASParamsQr,FASParamsGeoQr}, sdof::Oscillator{T}; fc_fun::Symbol=:Brune, amp_model::Symbol=:AlAtik2021_cy14) where T<:Real
	# compute first three spectral moments
	mi = spectral_moments([0, 1, 2], m, r, fas, sdof, fc_fun=fc_fun, amp_model=amp_model)
	m0 = mi[1]
	m1 = mi[2]
...
peak_factor_dk80(6.0, 10.0, fas, sdof)
peak_factor_dk80_gk(6.0, 10.0, fas, sdof)
...
"""
	peak_factor(m::T, r::T, fas::Union{FASParams,FASParamsGeo,FASParamsQr,FASParamsGeoQr}, sdof::Oscillator{T}; pf_method::Symbol=:DK80, fc_fun::Symbol=:Brune, amp_model::Symbol=:AlAtik2021_cy14) where T<:Real
...
Defaults to `:DK80`.
"""
function peak_factor(m::T, r::T, fas::Union{FASParams,FASParamsGeo,FASParamsQr,FASParamsGeoQr}, sdof::Oscillator{T}; pf_method::Symbol=:DK80, fc_fun::Symbol=:Brune, amp_model::Symbol=:AlAtik2021_cy14) where T<:Real
	if pf_method == :CL56
		return peak_factor_cl56(m, r, fas, sdof, fc_fun=fc_fun, amp_model=amp_model)
	else
		return peak_factor_dk80(m, r, fas, sdof, fc_fun=fc_fun, amp_model=amp_model)
	end
end
